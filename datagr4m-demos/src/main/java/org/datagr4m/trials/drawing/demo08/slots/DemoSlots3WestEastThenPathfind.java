...
public class DemoSlots3WestEastThenPathfind extends AbstractDemo{
    public static void main(String[] args) throws PathFinderException {
        PathObstacle oLeft1 = new PathObstacle("obsLeft1", 0,0,100,100);
        PathObstacle oLeft2 = new PathObstacle("obsLeft2", 0,500,100,100);
        PathObstacle oLeft3 = new PathObstacle("obsLeft3", 0000,1000,100,100);
        PathObstacle oRight1 = new PathObstacle("oRight1", 1000,0,100,100);
        PathObstacle oRight2 = new PathObstacle("oRight2", 1000,250,100,100);
        PathObstacle oRight3 = new PathObstacle("oRight3", 1000,500,100,100);
        PathObstacle oRight4 = new PathObstacle("oRight4", 1000,750,100,100);
        ...
        PathFinder3 finder = new PathFinder3();
        g.run(finder);
    }
}
