...
public class View implements IView {
    ...
    public void updateViewBounds() {
        ...
        Point2D bottomRight = new Point2D.Double(display.getSize().width, display.getSize().height);
    ...
    public void updateViewPoint() {
        Point2D viewPoint = new Point2D.Double(display.getSize().width / 2, display.getSize().height / 2);
    ...
    /*
     * public void fit(IHierarchicalModel model) { display.getView().fit(
    ...
    public void centerAt(Coord2d position) {
        Point2D screenCenter = new Point2D.Double(display.getSize().width / 2, display.getSize().height / 2);
    ...
    public Coord2d getLayoutScale(Rectangle2D r) {
        ...
        return new Coord2d(view.getWidth() / r.getWidth(), view.getHeight() / r.getHeight());
    }
    ...
    public void render(Graphics2D g2d) {
        ...
        if (showViewBounds) {
            ...
            g2d.drawRect((int) viewBounds.getMinX(), (int) viewBounds.getMinY(), (int) viewBounds.getWidth(), (int) viewBounds.getHeight());
    ...
    /**
     * Converts absolute mouse coordinates to coordinates relative to the rendered layout.
     */
    @Override
    ...
    @Override
    public void scale(float xRatio, float yRatio, Point2D from, boolean refreshNow) {
    ...
    @Override
    public void setScale(float xRatio, float yRatio, Point2D from, boolean refreshNow) {
    ...
    @Override
    public void setGridRendererSettings(GridRendererSettings gridRendererSettings) {
